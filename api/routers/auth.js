...
//ruta para registrar en back //http://localhost:3001/api/auth/register
router.post("/register", async (req, res) => {
  ...
  const user = new User({
    ...
    pass: password,
    image: req.body.image || "https://cdn-icons-png.flaticon.com/512/1077/1077063.png"
  });
  try {
...
//ruta para loguearse en back //http://localhost:3001/api/auth/login
